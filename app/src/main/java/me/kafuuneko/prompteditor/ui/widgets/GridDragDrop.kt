package me.kafuuneko.prompteditor.ui.widgets
...
internal constructor(
    ...
    private var _draggingItemDraggedDelta by mutableStateOf(Offset.Zero)
    private var _draggingItemInitialOffset by mutableStateOf(Offset.Zero)
    internal val draggingItemOffset: Offset
        get() = _draggingItemLayoutInfo?.let { item ->
            _draggingItemInitialOffset + _draggingItemDraggedDelta - item.offset.toOffset()
        } ?: Offset.Zero

    private val _draggingItemLayoutInfo: LazyGridItemInfo?
    ...
    internal fun onDragStart(offset: Offset) {
        state.layoutInfo.visibleItemsInfo.firstOrNull { item ->
            ...
            _draggingItemInitialOffset = it.offset.toOffset()
        }
    }
    ...
    internal fun onDragInterrupted() {
        ...
        _draggingItemDraggedDelta = Offset.Zero
        draggingItemIndex = null
        _draggingItemInitialOffset = Offset.Zero
    }

    internal fun onDrag(offset: Offset) {
        _draggingItemDraggedDelta += offset

        val draggingItem = _draggingItemLayoutInfo ?: return
